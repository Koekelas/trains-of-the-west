...
var map = require("./map"),
    pocketKnife = require("./pocketKnife"),
    ...
    prototype = {
         ...
         *   @param {server.support.event} callback.event The event helper.
         *   @param {any} [callback.extraArguments] The zero or more extra arguments passed to {{#crossLink "server.support.listenable/trigger:method"}}listenable.trigger{{/crossLink}}.
         * @param {any} [data] The data to be passed to the callback. See {{#crossLink "server.support.event/getData:method"}}event.getData{{/crossLink}}.
